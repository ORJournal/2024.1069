...
function main()
    ...
    instance_path = joinpath("$(problem_folder)", "$(problem_name)_presolved.mps")
    ...
    JLD2.jldsave(joinpath("$(output_directory)","cuPDLP_$(problem_name)_presolved_$(tolerance).jld2"); res)
end

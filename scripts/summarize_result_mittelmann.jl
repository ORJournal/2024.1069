...
function main()
    ...
    open("../benchmark/mittelmann_lp_instances_list") do f
        while ! eof(f)
    ...
    for i in 1:length(instances)
        ...
        try
            ...
            append!(time_cupdlp_presolved, 15000)
        end
        ...
        try
            ...
            append!(time_firstorderlp, 15000)
        end
        ...
        try
            ...
            append!(time_primal_simplex_no_presolve, 15000)
        end
        ...
        try
            ...
            append!(time_primal_simplex_presolve, 15000)
        end
        ...
        try
            ...
            append!(time_dual_simplex_no_presolve, 15000)
        end
        ...
        try
            ...
            append!(time_dual_simplex_presolve, 15000)
        end
        ...
        try
            ...
            append!(time_barrier_no_presolve, 15000)
        end
        ...
        try
            ...
            append!(time_barrier_presolve, 15000)
        end      
    end
    ...
    CSV.write(joinpath("$(output_directory)","mittelmann_$(tolerance).csv"), df)
end
